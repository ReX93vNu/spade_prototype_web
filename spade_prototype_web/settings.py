"""
Django settings for spade_prototype_web project.
...
ROOT_URLCONF = 'spade_prototype_web.urls'
...
WSGI_APPLICATION = 'spade_prototype_web.wsgi.application'
ASGI_APPLICATION = 'spade_prototype_web.asgi.application'
